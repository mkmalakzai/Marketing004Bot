...
if(action==="admin_wallet_add"||action==="admin_wallet_remove"){var who=id;if(!/^\d{5,16}$/.test(who)||get("user_seen_"+who,"no")!=="yes")return;ask(action==="admin_wallet_add"?"admin_wallet_add":"admin_wallet_remove",who,(action==="admin_wallet_add"?"Add":"Remove")+" balance for "+who+". Send USD amount, e.g. 5.00");return;}
